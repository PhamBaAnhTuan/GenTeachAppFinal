...
// components
import ListCart from '@/src/components/shop/ListCart';
import Header from '@/src/components/Header';
// actions
import { removeFromCartAction } from '@/src/store/actions';
// colors
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
               ...
               {cart
                  ...
                  : <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                     <Text style={{ fontSize: 15, fontWeight: 'bold', color: 'black' }}>Your cart is empty</Text>
                  </View>
               }
            </ScrollView>
